...
// Usage: npm run build && npm run preview   (then open preview/flowdeck-preview.html)
const fs = require("fs");
...
fs.writeFileSync(path.join(root, "preview/flowdeck-preview.html"), out);
console.log("preview → preview/flowdeck-preview.html");
