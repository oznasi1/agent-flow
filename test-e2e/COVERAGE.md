...
| `cap-sprints-handler-backstop` | CONNECTORS § 3. The capability table | Without `caps.sprints` a direct handler call reports "{label} doesn't have sprints." rather than throwing | todo |
