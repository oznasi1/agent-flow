...
| `orch-dry-run-gate-wording` | GUIDE § The Deck | A rule waiting on an unanswered gate reads "it is waiting on your answer" in the dry run | e2e: a dry run reports a waiting gate in words |
